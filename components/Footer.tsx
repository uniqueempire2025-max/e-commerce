        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="/posters" className="hover:text-white transition-colors">Posters</a></li>
              <li><a href="/frames" className="hover:text-white transition-colors">Frames</a></li>
              <li><a href="/custom" className="hover:text-white transition-colors">Custom Poster</a></li>
